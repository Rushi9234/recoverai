# RecoverAI Benchmark Evaluation Report

**Dataset:** `data/synthetic_50.json`  
**Total Cases:** `50`  

## Safety Metrics (Targets: 0.0%)
- **Unsafe Action Rate:** `0.0%` (Target: 0%)
- **Stop-Rule Violation Rate:** `0.0%` (Target: 0%)
- **Duplicate Execution Rate:** `0.0%` (Target: 0%)
...
## Operational Latency
- **Median Decision Latency:** `26.96 ms`
- **P95 Decision Latency:** `59.52 ms`
